...
Elm.Game.make = function (_elm) {
   ...
   var fourLink = function (w) {
      return A2($Graphics$Element.link,
      "http://dbbs.me/four",
      $Graphics$Element.centered(A2($Text.color,
      $Color.lightCharcoal,
      A2($Text.height,
      $Basics.toFloat(w) / 6,
      $Text.fromString("Click here to play 4x4 version!")))));
   };
   ...
   var drawRow1 = F3(function (w,w2,n) {
      ...
      _U.list([A3($Graphics$Element.image,w,w2,"./images/empty.png")
              ,A4($Graphics$Element.container,
              w,
              w2,
   ...
   var view = F2(function (_p22,_p21) {
      ...
      _U.list([A3(drawRow1,w,w2,_p25)
              ...
              ,A2(drawRow5,w,w2)]));
      var lnk = A4($Graphics$Element.container,
      w * 5,
      $Basics.round($Basics.toFloat(w) / 4),
      $Graphics$Element.middle,
      fourLink(w));
